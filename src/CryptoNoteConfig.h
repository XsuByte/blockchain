// Copyright (c) 2012-2018, The CryptoNote developers, The Bytecoin developers, xsubyte dev's, xsubyte dev
//
...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 48693;
...
const uint64_t GENESIS_BLOCK_REWARD                          = UINT64_C(15000000000000000);
...
const char     CRYPTONOTE_NAME[]                             = "xsubyte";
...
const int      P2P_DEFAULT_PORT                              =  3426;
const int      RPC_DEFAULT_PORT                              =  3427;
...
const char* const SEED_NODES[] = { "91.205.175.147:3426", "79.143.177.13:3426" };
